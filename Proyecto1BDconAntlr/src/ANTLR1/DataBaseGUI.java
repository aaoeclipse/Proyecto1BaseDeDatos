...
public class DataBaseGUI extends JFrame {
	...
	public DataBaseGUI() throws IOException {
		...
		textArea.setBounds(100, 100, 2475, 431);
		contentPane.add(textArea);
		
		
		table = new JTable();
		table.setFont(new Font("Consolas", Font.PLAIN, 25));
		table.setBounds(100, 600, 2475, 770);
		...
		btnNewButton.setBounds(446, 58, 58, 36);
		...
		btnNewButton_1.setBounds(100, 58, 67, 36);
		...
		btnNewButton_2.setBounds(261, 58, 67, 36);
