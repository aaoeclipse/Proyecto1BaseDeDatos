...
public class Consola extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jTabbedPane1.setBackground(new Color(255, 228, 181));
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        if(evt.getSource()== jButton1){
            ...
            // creamos un lexer para char stream
            SqlLexer lexer = new SqlLexer(input);
            //lexer.removeErrorListeners();
            // token stream 
            CommonTokenStream tokens = new CommonTokenStream(lexer);

        // Creamos un parser para el token stream
            ...
            jTextPane2.setText(arraytoString(error));
